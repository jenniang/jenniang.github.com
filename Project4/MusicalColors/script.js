...
window.addEventListener("keydown", (event) => {
  ...
  if (event.code === 'KeyA') {
    ...
    document.getElementsByClassName('audioA')[0].play();
    document.getElementsByClassName('audioA')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyB') {
    ...
    document.getElementsByClassName('audioB')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyC') {
    ...
    document.getElementsByClassName('audioC')[0].play();
    document.getElementsByClassName('audioC')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyD') {
    ...
    document.getElementsByClassName('audioD')[0].play();
    document.getElementsByClassName('audioD')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyE') {
    ...
    document.getElementsByClassName('audioE')[0].play();
    document.getElementsByClassName('audioE')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyF') {
    ...
    document.getElementsByClassName('audioF')[0].play();
    document.getElementsByClassName('audioF')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyG') {
    ...
    document.getElementsByClassName('audioG')[0].play();
    document.getElementsByClassName('audioG')[0].volume = "0.15";
  }
  ...
  if (event.code === 'KeyH') {
    ...
    document.getElementsByClassName('audioH')[0].play();
    document.getElementsByClassName('audioH')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyI') {
    ...
    document.getElementsByClassName('audioI')[0].play();
    document.getElementsByClassName('audioI')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyJ') {
    ...
    document.getElementsByClassName('audioJ')[0].play();
    document.getElementsByClassName('audioJ')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyK') {
    ...
    document.getElementsByClassName('audioK')[0].play();
    document.getElementsByClassName('audioK')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyL') {
    ...
    document.getElementsByClassName('audioL')[0].play();
    document.getElementsByClassName('audioL')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyM') {
    ...
    document.getElementsByClassName('audioM')[0].play();
    document.getElementsByClassName('audioM')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyN') {
    ...
    document.getElementsByClassName('audioN')[0].play();
    document.getElementsByClassName('audioN')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyO') {
    ...
    document.getElementsByClassName('audioO')[0].play();
    document.getElementsByClassName('audioO')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyP') {
    ...
    document.getElementsByClassName('audioP')[0].play();
    document.getElementsByClassName('audioP')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyQ') {
    ...
    document.getElementsByClassName('audioQ')[0].play();
    document.getElementsByClassName('audioQ')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyR') {
    ...
    document.getElementsByClassName('audioR')[0].play();
    document.getElementsByClassName('audioR')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyS') {
    ...
    document.getElementsByClassName('audioS')[0].play();
    document.getElementsByClassName('audioS')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyT') {
    ...
    document.getElementsByClassName('audioT')[0].play();
    document.getElementsByClassName('audioT')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyU') {
    ...
    document.getElementsByClassName('audioU')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyV') {
    ...
    document.getElementsByClassName('audioV')[0].play();
    document.getElementsByClassName('audioV')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyW') {
    ...
    document.getElementsByClassName('audioW')[0].play();
    document.getElementsByClassName('audioW')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyX') {
    ...
    document.getElementsByClassName('audioX')[0].play();
    document.getElementsByClassName('audioX')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyY') {
    ...
    document.getElementsByClassName('audioY')[0].play();
    document.getElementsByClassName('audioY')[0].volume = "0.08";
  }
  ...
  if (event.code === 'KeyZ') {
    ...
    document.getElementsByClassName('audioZ')[0].play();
    document.getElementsByClassName('audioZ')[0].volume = "0.08";
  }
